...
namespace ShermansLittleSecretWardrobe.Pages.Roles
{
    ...
    public class ManageModel : PageModel
    {
        ...
        public ManageModel(ShermansLittleSecretWardrobe.Data.ApplicationDbContext context,
       UserManager<IdentityUser> userManager, RoleManager<ApplicationRole> roleManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostAsync(string selectedusername, string selectedrolename)
        {
            ...
            IdentityUser AppUser = _context.Users.SingleOrDefault(u => u.UserName == selectedusername);
        ...
        public async Task<IActionResult> OnPostDeleteUserRoleAsync(string delusername, string delrolename)
        {
            ...
            IdentityUser user = _context.Users.Where(u => u.UserName == delusername).FirstOrDefault();
